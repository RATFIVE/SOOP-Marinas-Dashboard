      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col items-center p-8 gap-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6 w-full">
            <h3 className="text-lg font-bold mb-2">Badesteg Reventlou</h3>
            <p className="mb-2 text-gray-700 dark:text-gray-300">Hier können Infos zur Station Badesteg Reventlou stehen.</p>
          </div>
        </div>
      </SidebarInset>
    </SidebarProvider>
