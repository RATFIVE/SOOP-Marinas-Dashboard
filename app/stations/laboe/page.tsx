...
export default function LaboePage() {
  return (
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col items-center justify-center p-8">
          <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6 w-full max-w-xl">
            <h1 className="text-2xl font-bold mb-4">Laboe</h1>
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">54.4011, 10.2222</div>
            <div className="grid grid-cols-2 gap-4 mt-2 mb-6">
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Average Wind</div>
                <div className="font-semibold">10.1 m/s</div>
              </div>
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Temperature</div>
                <div className="font-semibold">16.2 °C</div>
              </div>
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Water Level</div>
                <div className="font-semibold">0.38 m</div>
              </div>
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Salinity</div>
                <div className="font-semibold">13.8 PSU</div>
              </div>
            </div>
